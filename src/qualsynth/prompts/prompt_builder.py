...
class PromptBuilder:
    ...
    def __init__(
        ...
        few_shot_selection_strategy: str = "mixed",
        ...
        Args:
            ...
            dynamic_few_shot: Whether to vary few-shot examples across iterations
            few_shot_selection_strategy: Strategy for selecting few-shot examples
        ...
        self.few_shot_selection_strategy = few_shot_selection_strategy
...
Example: If generating 20 samples and a feature has 5 possible values, use at least 3-4 different values across the 20 samples, not just 1 value."""
        ...
        if self.use_few_shot and len(X_train) > 0:
            ...
            representative_samples = FewShotBuilder.select_representative_samples(
                ...
                sensitive_features=sensitive_features,
                target_group=target_group,
                iteration=iteration if self.dynamic_few_shot else 0,
                selection_strategy=self.few_shot_selection_strategy
            )
