...
def analyze_dataset(dataset_name: str, data_dir: str = "data/raw") -> Dict:
    ...
    # 4. Overlap analysis (simplified)
    print("\n4. OVERLAP ANALYSIS")
    print("-" * 70)
    
    # Calculate feature-wise overlap between classes
    overlap_scores = {}
    ...
    # Identify minority class samples in sparse regions
    minority_samples = X[y == 1]
    
    # Simple density estimation: count neighbors within radius
